    ...
    try {
      const result = await this.directionsRoutePromise({
        ...
        waypoints: [
          ...
          //-2.908306335426701, -41.78020709515823
          //-2.9164025860866425, -41.78053975240495
          { location: { lat: -2.908306335426701, lng: -41.78020709515823 } },
          { location: { lat: -2.9164025860866425, lng: -41.78053975240495 } },
